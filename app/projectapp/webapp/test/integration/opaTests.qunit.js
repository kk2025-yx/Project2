...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/ai/adapter/projectapp/test/integration/FirstJourney",
    "com/ai/adapter/projectapp/test/integration/IntegrationTasksListJourney",
    "com/ai/adapter/projectapp/test/integration/IntegrationTasksObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
